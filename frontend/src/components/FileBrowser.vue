      ...
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr
            ...
            :key="item.path"
            class="border-b border-gray-100 dark:border-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors"
          >
            <!-- Name -->
            <td class="px-5 py-3">
              <button
                ...
                :class="item.is_dir ? 'text-indigo-500 dark:text-indigo-400 hover:text-indigo-600 dark:hover:text-indigo-300 cursor-pointer' : 'text-gray-700 dark:text-gray-200 cursor-default'"
              >
                <svg v-if="item.is_dir" class="w-4 h-4 shrink-0 text-indigo-500 dark:text-indigo-400" fill="currentColor" viewBox="0 0 24 24">
